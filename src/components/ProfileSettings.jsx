...
const ProfileSettings = ({user, setMessage}) => {
  return (
    <div className='user-profile-settings'>
        <div className='settings-1'>
            <h2>Your account settings</h2>
            <form onSubmit={e => handleUpdate(e, setMessage)}>
            ...
            <LabelInputField label=<img src="" alt="user-pic" /> id='pic' name='pci' type='file' />
        ...
        <div className="settings-2">
            ...
            <LabelInputField label='Confirm Password' id='confirmPassword' name='confirmPassword' type='password' />
